...
const CTA = () => {
  return (
    ...
    before:content-[''] before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-[-1] before:rounded-xl before:bg-[#f0ff18] before:bg-opacity-20 before:transition-all before:duration-100 before:ease-in-out before:hover:bg-opacity-80 before:hover:backdrop-blur-[0px] before:hover:duration-300 before:hover:ease-in-out before:animate-pulse 
    ">
      <img src="/cta.png" alt=''/>
